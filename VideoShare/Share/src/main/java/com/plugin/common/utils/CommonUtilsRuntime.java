 ...
 */
public final class CommonUtilsRuntime {
	...
	public static String getCurrentStackMethodName() {
        ...
        if (!TextUtils.isEmpty(invokeMethodName) && invokeMethodName.equals("LOGD")
                &&!TextUtils.isEmpty(className) && className.equals("com.plugin.common.utils.CommonUtilsConfig")) {
            ste = steArray[5];
            invokeMethodName = ste.getMethodName();
        }
